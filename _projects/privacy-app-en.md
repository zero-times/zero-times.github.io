...
decisions:
  ...
  - title: Let privacy shape the structure early
    description: The product boundary is decided during information and interaction design, not after implementation is already fixed.
  - title: Keep the first version inside a realistic delivery scope
